...
public class Find_Pas
{
    static void Main()
    {
        ...
        string res = @"C:\info_security\practice2\practice_2.2\result.txt";
        byte[] findContent = File.ReadAllBytes(@"C:\info_security\practice2\practice_2.2\encfile5.dat").ToArray();
