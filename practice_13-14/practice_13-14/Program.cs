...
class Authorization
{
    static void Main()
    {
        ...
        do
        {
            ...
            if (choice.ToLower() == "yes")
            {
                ...
                string[] roles = { "admin", "finance", "it", "safety" };
            ...
            {
                logger.Fatal("Wrong input {input}", choice);
            }
    ...
    public class Role
    {
        ...
        public static void OnlyForAdmins()
        {
            ...
            {
                logger.Error("User must be a member of Admins to access this feature.");
            }
            else
            {
        ...
        public static void OnlyForFinancemanager()
        {
            ...
            {
                logger.Error("User must be a member of Finance managers to access this feature.");
            }
            else
            {
                Console.WriteLine("\nAll material is on your page");
        ...
        public static void OnlyForITTechnician()
        {
            ...
            {
                logger.Error("User must be a member of IT Technicians to access this feature.");
            }
            else
            {
                Console.WriteLine("\nAll material is on your page");
        ...
        public static void OnlyForSafetyManager()
        {
            ...
            {
                logger.Error("User must be a member of Safety Managers to access this feature.");
            }
            else
            {
                Console.WriteLine("\nAll material is on your page");
